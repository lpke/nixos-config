{
  programs.plasma = {
    ...
    # nix settings generator from plasma files in `~/.config`: `rc2nix`
    # note that some things won't be perfect after running this command

    # SETTINGS HERE...

    # AUTO-GENERATED 21-01-2026 1:50pm

    # shortcuts = {
    #   ActivityManager.switch-to-activity-d047f45f-b07f-433d-8d9b-aa1cc7ad7016 = [ ];
    ...
    #   kwin."Window Close" = ["Ctrl+Del" "Meta+/"];
    ...
    #   dolphinrc.General.ViewPropsTimestamp = "2026,1,7,20,39,2.866";
